	...
	public class Story {
		...
		public static function mainStory(eventNum:Number) {
			...
			if (eventNum == 29.1) {
				...
				Core.text.gameOutput("\r\rAfter a few more attempts, your "+Core.pc.buttHole()+" suddenly gives without warning and Brian is able to slide his dick deep into your "+Core.pc.buttHole()+". It hurts at first, so he moves slowly. The slow friction is oddly soothing and the pain is soon replace by the tingling sensation of pleasure. Your [pcCock] swells and twitches as Brian’s dick rubs against your prostate with each deep thrust your stretched "+Core.pc.buttHole()+" twitches and squeezes. As Brian pounds your back-side relentlessly, you grab your [pcCock] with one hand while balancing your weight on other and start to masturbate rigorously, [pcBalls] tightening as you feel the tingle of release getting stronger and stronger in the base of your [pcCock].", false);
				Core.text.gameOutput("\r\rBrian groans loudly as he slams his hips into your ass a few times, shooting his load of hot jizz deep into your "+Core.pc.buttHole+". The sensation is too much for you to bear and you fire your own load, making a sizable puddle on the grass underneath you and rubbing the rest all over your [pcCock] and hand as you finish squeezing out the last few drops. Finished, Brian carefully slides his deflating penis out of your quivering "+Core.pc.buttHole()+", allowing you to collapse on your side, arm finally giving out. You two move to a cleaner spot to lay down and relish in the afterglow. The pair of you lay close together but you find yourself immediately drifting off to enjoy a nap.", false);
				Core.buttons.button(1, "Next", 30);
			}
			//Fuck Brian
			if (eventNum == 29.2) {
				Core.text.gameOutput("You tell Brian you want him to go first. He seems quite surprised by the suggestion but agrees to the idea. The two of you take off your clothes, the two of you standing there and staring at each other. Brian has more muscle tone that you due to helping with his father’s work. Though you are excited and nervous with anticipation, your "+Core.pc.penis()+" seems slower to react, only sitting at half-mast.", true);
			...
			if (eventNum == 49) {
				Core.text.gameOutput("Awhile later, two serving wenches comes to the table; one carrying a tray laden with food and the other with large clay mugs. Surprisingly, one is placed in front of you, along with a plate and dining utensils. The tray of food is set between you and the reptilian man. The amount of food is more than any one person can eat and it makes you a bit jealous to see all that food in front of you, just out of reach…", true);
