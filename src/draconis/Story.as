		...
		public static function mainStory(eventNum:Number) {
			...
			if (eventNum == 29) {
				...
				if (Core.pc.penisArea > 0) {
					...
					Core.buttons.button(1, "Brian", 30);
					Core.buttons.button(2, "You", 31);
				}
				if (Core.pc.vaginaArea > 0) {
			...
			if (eventNum == 34) {
				...
				Core.buttons.button(1, "Kitchen", 35);
				Core.buttons.button(2, "Upstairs", 38);
			}
			...
			if (eventNum == 35) {
				...
				if (Core.container.motherContainer.Amulet) {
					...
					Core.buttons.button(1, "Take", 36);
				}
				Core.buttons.button(2, "Leave", 37);
			}
			...
			if (eventNum == 36) {
				...
				Core.pc.loot(Core.item.familyAmulet, 1);
				Core.buttons.button(1, "Next", 34);
			}
			//Leave the Kitchen
			if (eventNum == 37) {
			...
			if (eventNum == 39) {
				...
				Core.buttons.button(1, "Run!", 40);
				Core.buttons.button(2, "Stand", 41);
			}
			...
			if (eventNum == 42) {
				...
				Core.buttons.button(1, "Roots", 43);
				Core.buttons.button(2, "Canopy", 44);
			}
			...
			if (eventNum == 48) {
				...
				Core.buttons.button(1, "Fight!", 49);
			}
			...
			if (eventNum == 52) {
				...
				Core.buttons.button(1, "Wake Up", 53);
			}
			...
			if (eventNum == 54) {
				...
				Core.buttons.button(1, "Truth", 55);
				Core.buttons.button(2, "Lie", 56);
			}
			...
			if (eventNum == 59) {
				...
				Core.buttons.button(1, "Go With", 60);
				Core.buttons.button(2, "Stay", 61);
			}
